...
export default function AdminPanel() {
    ...
    <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
      <View style={styles.statsGrid}>
        {[
          ...
          { label: 'Workouts This Week', value: '0', icon: 'swap-horizontal-outline' },
          { label: 'Challenge Completions', value: '0', icon: 'trophy-outline' },
          { label: 'Vimeo API Status', value: 'OK', icon: 'checkmark-circle-outline' },
        ].map((stat) => (
          <View key={stat.label} style={styles.statCard}>
            <View style={styles.statIconWrap}>
              <Ionicons name={stat.icon as any} size={24} color="rgba(255,255,255,0.6)" />
            </View>
  ...
  const renderWorkouts = () => (
    <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
      <View style={styles.subHeader}>
        <Text style={styles.subTitle}>Workout Library (155)</Text>
        <TouchableOpacity style={styles.syncBtn}>
          <Ionicons name="sync-outline" size={18} color="#000" />
          <Text style={styles.syncBtnText}>Sync with Vimeo</Text>
        </TouchableOpacity>
      </View>

      <View style={styles.cardList}>
        {[
          { id: '740268228', title: '10 Reps Workout ...', tag: 'Ohne Gewichten', duration: '22 min' },
          { id: '1166036905', title: '10. Legends Nev...', tag: 'General', duration: '20 min' },
          { id: '1163955086', title: '10. Unstoppable', tag: 'Explosiveness', duration: '24 min' },
          { id: '1166035222', title: '11. The Foundation', tag: 'General', duration: '20 min' },
        ].map((workout) => (
          <View key={workout.id} style={styles.workoutCard}>
            <View style={styles.thumbnailPlaceholder}>
              <Ionicons name="play-circle-outline" size={24} color="rgba(255,255,255,0.2)" />
            </View>
            <View style={styles.cardMain}>
              ...
              <Text style={styles.idText}>{workout.id}</Text>
            </View>
  ...
  const renderChallenges = () => (
    <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.cardList}>
        {[
          { id: 'en-challenge-f-01', title: '3-Day Screen-Free Dinner', pts: '75 Pts', days: '3 Days', desc: 'Eating as a family without screens at the table' },
          { id: 'en-challenge-c-01', title: 'Gratitude Ritual', pts: '75 Pts', days: '3 Days', desc: 'For 3 days, write down 3 things that made your day special each evening.' },
        ].map((challenge) => (
  ...
  const renderUsers = () => (
    <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.userTable}>
        ...
        {[
          { name: 'Zane Tanner', initial: 'Z', id: '0XKe1ieBZjevgwprtpAg... ', email: 'bizu@ma...', pts: '0 Pts' },
          { name: 'Thomas Buck', initial: 'T', id: 'H0eeZZGudV0YrPt3ble...', email: 'kaxijed19...', pts: '0 Pts' },
          { name: 'Admin', initial: 'A', id: 'RqKkVDoSToDAFp2rdNHEG...', email: 'office@v...', pts: '115 Pts' },
        ].map((user) => (
          <View key={user.name} style={styles.userRow}>
             ...
             <View style={{ alignItems: 'flex-end' }}>
                ...
                <View style={[styles.ptsBadgeMini, { backgroundColor: user.pts === '0 Pts' ? 'rgba(245,158,11,0.2)' : Colors.accentGold }]}>
          ...
          <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.broadcastCard}>
              <View style={styles.broadcastHeader}>
                <Ionicons name="radio-outline" size={24} color={Colors.accentBlue} />
                ...
                <View key={idx} style={styles.activityPostCard}>
                  <View style={styles.postHeader}>
                    <View style={styles.postAvatar}>
                      <Text style={styles.postAvatarText}>{post.name.charAt(0)}</Text>
                    </View>
                    <View style={{ flex: 1, marginLeft: 12 }}>
    ...
    <SafeAreaView style={styles.safeContainer}>
      ...
      <View style={styles.tabsContainer}>
        ...
        <View style={styles.tabUnderlineTrack}>
           <View style={[styles.tabUnderline, { width: 100, transform: [{ translateX: ADMIN_TABS.findIndex(t => t.id === activeTab) * 50 }] }]} />
        </View>
      </View>
