...
const styles = StyleSheet.create({
  ...
  mealSearchInput: { flex: 1, backgroundColor: '#0D0D1E', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, color: '#fff', fontSize: 14, fontFamily: 'Inter_400Regular', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
